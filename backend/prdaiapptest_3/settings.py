"""
Django settings for prdaiapptest_3 project.
...
ROOT_URLCONF = 'prdaiapptest_3.urls'
...
WSGI_APPLICATION = 'prdaiapptest_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "prdaiapptest_3 API",
    "DESCRIPTION": "API documentation for prdaiapptest_3 App",
    "VERSION": "v1",
}
